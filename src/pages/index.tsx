        ...
        <div className="h-screen pb-14 bg-right bg-cover" style={{ backgroundImage: `url(/bg.svg)` }}>
          ...
          <div className="container pt-24 md:pt-48 px-6 mx-auto flex flex-wrap flex-col md:flex-row items-center">
            ...
            <div className="w-full pt-16 pb-6 text-sm text-center md:text-left fade-in">
              ...
              {!session && (
                <div>
                  <a className="text-gray-500 no-underline hover:no-underline" href="#">&copy; NOT SIGNED IN</a>
                  <button onClick={() => signIn()}>Sign IN</button>
                </div>
              )}
              {session && <a className="text-gray-500 no-underline hover:no-underline" href="#">&copy; Oaktree POC 2023</a>}
              {session && (
                <div>
